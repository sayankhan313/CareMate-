...
export const PharmacyOrdersScreen = () => {
  const navigation =
    useNavigation<PharmacyNavigation>();

  const route =
    useRoute<
      RouteProp<
        PharmacyOrdersRouteList,
        "PharmacyOrders"
      >
    >();
  ...
  const [filter, setFilter] =
    useState<QueueFilter>(initialFilter);

  const [orders, setOrders] =
    useState<PharmacyOrderListItem[]>([]);
