...
router.post(
  "/prescription-charge/evidence",
  uploadPatientPharmacyExemptionEvidence,
  patientPrescriptionChargeController.submitEvidence,
);
...
router.post(
  "/pharmacy-orders/:orderId/payment-intent",
  patientPaymentController.createPaymentIntent,
);

router.post(
  "/pharmacy-orders/:orderId/payment-confirm",
  patientPaymentController.confirmPayment,
);
...
router.get(
  "/medicine-pack-reference",
  medicinePackReferenceController.getPackReference,
);
